...
export class Snake extends AcGameObject {
    constructor(info, gamemap) {
        ...
        this.cells = [new Cell(info.r, info.c)]//存放蛇的身体，cells[0]存放舌头
        this.next_cell = null; //下一步的目标位

        this.speed = 5;
        this.direction = -1;//-1表示没有指令，0/1/2/3表示上右左下
        ...
        this.eye_dx = [//蛇眼睛不同x的方向
            [-1, 1],
            [1, 1],
            [1, -1],
            [-1, -1],
        ]
        this.eye_dy = [//蛇眼睛不同y的方向
            [-1, -1],
            [-1, 1],
            [1, 1],
            [1, -1],
