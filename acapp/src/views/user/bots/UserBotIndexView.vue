                    ...
                    <tbody>
                        <tr v-for="bot in bots" :key="bot.id">
                            ...
                            <td>
                                ...
                                <div class="game-modal" :id="'update-bot-modal-' + bot.id" tabindex="-1"
                                    ...
                                    <div>
                                        <div>
                                            <label for="add-bot-title">名称</label>
                                            <input style="width: 85%" v-model="bot.title" type="text" id="add-bot-title"
                                                placeholder="请输入Bot名称">
                                        </div>
                                        <div>
                                            <label for="add-bot-description">简介</label>
...
export default {
    ...
    setup() {
        ...
        const refresh_bots = () => {
            $.ajax({
                url: "https://app4141.acapp.acwing.com.cn/api/user/bot/getlist/",
                type: "get",
                headers: {
        ...
        const add_bot = () => {
            ...
            $.ajax({
                url: "https://app4141.acapp.acwing.com.cn/api/user/bot/add/",
                type: "post",
                data: {
                    title: botadd.title,
        ...
        const update_bot = (bot) => {
            botadd.error_message = "";
            $.ajax({
                url: "https://app4141.acapp.acwing.com.cn/api/user/bot/update/",
                type: "post",
                data: {
                    bot_id: bot.id,
                    title: bot.title,
        ...
        const remove_bot = (bot) => {
            $.ajax({
                url: "https://app4141.acapp.acwing.com.cn/api/user/bot/remove/",
                type: "post",
                data: {
                    bot_id: bot.id,
                },
