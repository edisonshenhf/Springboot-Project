...
export default {
  ...
  setup() {
    ...
    const jwt_token = "eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiI2MTcyZWQzMDJjMjg0MWJhYjhlNDA0MTk2MmZhODBkYSIsInN1YiI6IjgiLCJpc3MiOiJzZyIsImlhdCI6MTY3MDAwNDc5NiwiZXhwIjoxNjcxMjE0Mzk2fQ.hzzod50pZYSqzNMh4Kh4l91mlVEUPUePs5joTy-C490";
    if (jwt_token) {
